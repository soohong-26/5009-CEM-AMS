...
public class LoginPage extends javax.swing.JFrame {
    ...
    //Login procedure, to validate all the things
    private void loginProcedure () {
        ...
        if (account.getRole().equals("GUARD")) {
            this.account.getAccountEntries().timeIn(this.account.getAccountID(), this.account.getRole());
            dispose();
        ...
        if (account.getRole().equals("RESIDENT")) {
            ...
            rAccount.setAccountID((Integer) this.account.getAccountID());
            rAccount.setUsername(this.account.getUsername());
            rAccount.setPassword(this.account.getPassword());
            rAccount.getAccountEntries().timeIn(rAccount.getAccountID(), this.account.getRole());
            dispose();
            ProfilePage pp = new ProfilePage(rAccount);
            pp.setVisible(true);
            return;
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setBackground(new java.awt.Color(247, 127, 0));
